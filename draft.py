...
import glob
import numba
from face3d.utils import crop_face_landmarks, resize_face_landmarks, show_ndarray_img, show_pts, show_vertices
...
def pt3d_to_3dmm():
    ...
    # img = cv2.imread('examples/Data/AFLW2000/image00050.jpg')
    # pt = sio.loadmat('examples/Data/AFLW2000/image00050.mat')['pt3d_68'][:2].T
    ...
    # cv2.imwrite(f'examples/results/AFLW2000/{name}_rot.jpg', cv2_img)
    # shutil.copyfile(img_path, f'examples/results/AFLW2000/{name}.jpg')
